...
exports.SosModule = SosModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([sos_alert_entity_1.SosAlert, user_entity_1.User])],
        controllers: [sos_controller_1.SosController, sos_controller_1.SosAliasController],
